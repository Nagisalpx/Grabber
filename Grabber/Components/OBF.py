...
class OBF:
    ...
    def encrypt1(self):
        ...
        init = ";".join(init)
        self.code = f'''
# Obfuscated using https://github.com/Nagisalpx/Grabber-env/tree/main/OBF-2
...
'''.strip().encode()
    ...
    def encrypt2(self):
        ...
        self.code = f'''# Obfuscated using https://github.com/Nagisalpx/Grabber-env/tree/main/OBF-2
...
'''.strip().encode()
    ...
    def encrypt3(self):
        ...
        self.code = f'# Obfuscated using  base64, lzma; exec(compile(lzma.decompress(base64.b64decode({data})), "<string>", "exec"))'.encode()
